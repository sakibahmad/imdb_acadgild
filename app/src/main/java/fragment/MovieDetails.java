...
public class MovieDetails extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (movie.getPoster().equals("null")) {
            poster.setImageResource(R.drawable.empty);
        } else {
        ...
        favorites.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tag == "disable") {
                    favorites.setImageResource(R.drawable.favorite_start);
                    ...
                    favorites.setImageResource(R.drawable.favorite_stop);
        ...
        watchlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tag == "disable") {
                    watchlist.setImageResource(R.drawable.watchlist_enable);
                    ...
                    watchlist.setImageResource(R.drawable.watchlist_disable);
    ...
    private MovieInfo getMovie(String id) {
        ...
        try {
            movieInfo = new async.MovieDetails(getActivity()).execute(URL).get();
    ...
    private void showCast() {
        ...
        try {
            List<Cast> castList = new Crew(getActivity(), Constants.TAG_CAST).execute(URL).get();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (cast != null) {
                ...
                if (cast.getProfilePath().equals("null")) {
                    thumbnailImage.setImageResource(R.drawable.empty);
                } else {
    ...
    private void showCrew() {
        ...
        try {
            List<Cast> castList = new Crew(getActivity(), Constants.TAG_CREW).execute(URL).get();
    ...
    private void showTrailers() {
        ...
        try {
            List<Cast> castList = new Crew(getActivity(), Constants.TAG_RESULTS).execute(URL).get();
    ...
    private void showPosters() {
        ...
        try {
            List<Cast> castList = new Crew(getActivity(), Constants.TAG_POSTERS).execute(URL).get();
